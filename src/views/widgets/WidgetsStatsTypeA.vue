  ...
  <CRow>
    <CCol :xs="6" :s="3">
      <CWidgetStatsA class="mb-4" color="primary">
        <template #title>Active Links</template>
        <template #value>43,225</template>
        <template #action>
    ...
    <CCol :xs="6" :s="3">
      <CWidgetStatsA class="mb-4" color="info">
        <template #value>447</template>
        <template #title>Read Links</template>
        <template #action>
          <CDropdown placement="bottom-end">
            <CDropdownToggle
              color="transparent"
    ...
    <CCol :xs="6" :s="3">
      <CWidgetStatsA class="mb-4" color="warning">
        ...
        <template #title>Requested Links</template>
        <template #action>
          <CDropdown placement="bottom-end">
            <CDropdownToggle
              color="transparent"
    ...
    <CCol :xs="6" :s="3">
      <CWidgetStatsA class="mb-4" color="danger">
        <template #value>20</template>
        <template #title>Expired Links</template>
        <template #action>
          <CDropdown placement="bottom-end">
            <CDropdownToggle
              color="transparent"
